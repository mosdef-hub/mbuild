    ...
    with open(filename, 'w') as f:
        ...
        for angle in structure.angles:
            ...
            for ub in structure.urey_bradleys:
                if (((angle.atom1, angle.atom3) == (ub.atom1, ub.atom2)) or
                        (angle.atom3, angle.atom1) == (ub.atom1, ub.atom2)):
                    unique_ubs.add((angle.atom1.atom_type.name,
        ...
        for ub in unique_ubs:
            f.write('{:8s} {:8s} {:8s} {:.5f} {:.5f} {:.5f} {:.5f}\n'.format(
                ub[0], ub[1], ub[2], ub[3].k, ub[3].theteq, ub[4].k, ub[4].req))
        ...
        for atype in unique_atypes:
            ...
            f.write('{:8s} {:8.3f} {:8.3f} {:8.3f} {:8.3f} {:8.3f} {:8.3f}\n'.format(
                atype.name, 0.0, -1 *atype.epsilon, atype.rmin/2, 0.0,
                -1 * sc_nb * atype.epsilon, atype.rmin/2))
