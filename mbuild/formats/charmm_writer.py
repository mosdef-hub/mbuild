...
class Charmm:
    def __init__(
        ...
        box_0_vectors_mod = mb_box._lengths_angles_to_vectors(self.box_0.lengths, self.box_0.angles)
        ...
        if self.structure_box_1:
            ...
            box_1_vectors_mod = mb_box._lengths_angles_to_vectors(self.box_1.lengths, self.box_1.angles)
            # create box 0 vector list and convert from nm to Ang and round to 6 decimals
