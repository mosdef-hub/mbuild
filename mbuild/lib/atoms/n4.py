...
class N4(mb.Compound):
    ...
    def __init__(self):
        ...
        mb.spin(self['port_2'], 2/3*np.pi, [1, 0, 0])
        mb.spin(self['port_3'], -2/3*np.pi, [1, 0, 0])
        mb.spin(self['port_1'], 1/3*np.pi, [0, 0, 1])
        mb.spin(self['port_2'], -1/3*np.pi, [0, 0, 1])
        mb.spin(self['port_3'], -1/3*np.pi, [0, 0, 1])
