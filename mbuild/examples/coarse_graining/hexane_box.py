...
if __name__ == '__main__':
    ...
    united_atom_leaves = [CH2, CH3]
    three_to_one_leaves = [Propane]

    united_atom = mb.coarse_grain(hexane_box, leaf_classes=united_atom_leaves)

    three_to_one = mb.coarse_grain(hexane_box, leaf_classes=three_to_one_leaves)

    # print("Proxy: {}".format(proxy))
    #
    # print("Leaves of the proxy:")
    # for i, leaf in enumerate(proxy.leaves):
    #     print("{}: {}".format(i, leaf))
