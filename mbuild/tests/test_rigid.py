...
class TestRigid(BaseTest):
    ...
    def test_fill_box_rigid(self, rigid_benzene):
        ...
        assert (
            len(list(filled.rigid_particles()))
            == n_benzenes * rigid_benzene.n_particles
        )
    ...
    def test_label_rigid_bodies_after_fill(self, benzene):
        ...
        assert (
            len(list(filled.rigid_particles()))
            == n_benzenes * benzene.n_particles
        )
    ...
    def test_label_rigid_bodies_list_particle_list(self, benzene):
        ...
        filled.label_rigid_bodies(
            discrete_bodies=["Benzene0", "Benzene1"], rigid_particles=["C", "H"]
        )
    ...
    def test_create_semi_rigid_bodies_hierarchy(self, benzene_from_parts):
        n_benzenes = 10
        filled = mb.fill_box(
            benzene_from_parts, n_compounds=n_benzenes, box=[0, 0, 0, 4, 4, 4]
        )
    ...
    def test_create_semi_rigid_bodies_filled_no_increment(
    ...
    def test_delete_body(self, rigid_benzene):
        ...
        assert (
            len(list(filled.rigid_particles()))
            == (n_benzenes - 1) * rigid_benzene.n_particles
        )
    ...
    def test_delete_body_multiple(self, rigid_benzene):
        ...
        assert (
            len(list(filled.rigid_particles()))
            == (n_benzenes - 2) * rigid_benzene.n_particles
        )
    ...
    def test_delete_body_all(self, rigid_benzene):
        ...
        for i, child in enumerate(filled.children[:-1]):
            ...
            assert (
                len(list(filled.rigid_particles()))
                == (n_benzenes - (i + 1)) * rigid_benzene.n_particles
            )
            assert filled.contains_rigid is True
