...
class TestGOMCControlFileWriter(BaseTest):
    ...
    def test_save_basic_NVT(self, ethane_gomc):
        ...
        with open("test_save_basic_NVT.conf", "r") as fp:
            variables_read_dict = {'Restart': False,
                                   'PRNG': False,
        ...
        assert variables_read_dict == {'Restart': True,
                                       'PRNG': True,
                                       'ParaTypeCHARMM': True,
                                       'Parameters': True,
                                       'Coordinates': True,
    ...
    def test_save_basic_NPT(self, ethane_gomc):
        ...
        with open("test_save_basic_NPT.conf", "r") as fp:
            variables_read_dict = {'Pressure': False,
                                   'Temperature': False,
                                   'PressureCalc': False,
                                   'RunSteps': False,
                                   'EqSteps': False,
        ...
        assert  variables_read_dict == {'Pressure': True,
                                        'Temperature': True,
                                        'PressureCalc': True,
                                        'RunSteps': True,
                                        'EqSteps': True,
    ...
    def test_save_basic_GCMC(self, ethane_gomc):
        ...
        with open("test_save_basic_GCMC.conf", "r") as fp:
            variables_read_dict = {'Parameters': False,
                                   'Coordinates 0': False,
                                   'Coordinates 1': False,
                                   'Structure 0': False,
                                   'Structure 1': False,
        ...
        assert variables_read_dict == {'Parameters': True,
                                       'Coordinates 0': True,
                                       'Coordinates 1': True,
                                       'Structure 0': True,
                                       'Structure 1': True,
    ...
    def test_save_basic_GEMC_NVT(self, ethane_gomc):
        ...
        with open("test_save_basic_GEMC_NVT.conf", "r") as fp:
            variables_read_dict = {'DisFreq': False,
                                   'RotFreq': False,
                                   'IntraSwapFreq': False,
                                   'SwapFreq': False,
                                   'RegrowthFreq': False,
        ...
        assert variables_read_dict == {'DisFreq': True,
                                       'RotFreq': True,
                                       'IntraSwapFreq': True,
                                       'SwapFreq': True,
                                       'RegrowthFreq': True,
    ...
    def test_adjustment_steps(self, ethane_gomc):
        ...
        with open("test_adjustment_steps.conf", "r") as fp:
            variables_read_dict = {'PressureCalc': False,
                                   'AdjSteps': False,
                                   'EqSteps': False,
                                   'CoordinatesFreq': False,
                                   'RestartFreq': False,
        ...
        assert variables_read_dict == {'PressureCalc': True,
                                       'AdjSteps': True,
                                       'EqSteps': True,
                                       'CoordinatesFreq': True,
                                       'RestartFreq': True,
